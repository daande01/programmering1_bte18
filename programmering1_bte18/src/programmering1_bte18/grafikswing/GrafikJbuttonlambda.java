...
public class GrafikJbuttonlambda extends JFrame { // ärver egenskaper från jframe denna klass blir alltså ett fönster
	...
	JButton b1 = new JButton("send form"); // skapar ett knapp objekt och skapar en referensvariabel till knappobjektet
											// så att jag i framtiden kan påverka knappen eller lyssna på knappen.
	...
	public GrafikJbuttonlambda() { // detta är en konstruktor som kör direkt när jag skapar ett objekt av klassen.
		...
		this.setLayout(new FlowLayout()); // sätter layout , definerar alltså hur objekten skall hamna i fönstret , flow
		...
		b1.addActionListener(e -> { // skapar en lyssnare med lambda utryck detta är enklare än actionperformed
									// varianten som finns i en annan fil här på github, för delen är att allt som
									// hör till denna knapp blir samlat på ett och samma ställe i koden bla
	...
	public static void main(String[] args) {
		...
		new GrafikJbuttonlambda(); // skapar ett objekt av denna klass vilket leder till att konstruktorn kör
									// vilket leder till att fönstret och de olika objekten ritas ut.
	}
